...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/sessions/{id}/tool-executions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.toolExecutionsListResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "handlers.toolExecutionResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "handlers.toolExecutionsListResponse": {
            "type": "object",
            "properties": {
                "executions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.toolExecutionResponse"
                    }
                },
                "total": {
                    "type": "integer"
